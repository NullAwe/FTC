...
/*
 * This routine is designed to tune the open-loop feedforward coefficients. Although it may seem
 * unnecessary,
            ...
            switch (mode) {
                case TUNING_MODE:
                    ...
                    double targetPower = Kinematics.calculateMotorFeedforward(motionState.getV(),
                            motionState.getA(), roadRunnerParameters.feedforwardParams.kV,
                            roadRunnerParameters.feedforwardParams.kA,
                            roadRunnerParameters.feedforwardParams.kStatic);
