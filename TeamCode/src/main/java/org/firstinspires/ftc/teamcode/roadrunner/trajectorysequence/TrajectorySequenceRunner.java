...
public class TrajectorySequenceRunner {
    ...
    private final boolean usingEncoder;
    ...
    private List<Integer> lastDriveEncPositions, lastDriveEncVels, lastTrackingEncPositions,
            lastTrackingEncVels;
    ...
    DriveSignal update(Pose2d poseEstimate, Pose2d poseVelocity) {
        ...
        if (driveSignal != null && !usingEncoder) {
            driveSignal = new DriveSignal(
...
//                    lastDriveEncPositions, lastDriveEncVels, lastTrackingEncPositions,
//                    lastTrackingEncVels
//            );
//        }
