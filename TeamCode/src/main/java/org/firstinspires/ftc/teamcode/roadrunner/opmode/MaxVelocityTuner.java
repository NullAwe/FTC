...
public class MaxVelocityTuner extends LinearOpMode {
    ...
    RoadRunnerParameters roadRunnerParameters;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!isStopRequested() && timer.seconds() < RUNTIME) {
            ...
            Pose2d poseVelo = Objects.requireNonNull(drive.getPoseVelocity(),
                    "poseVelocity() must not be null. Ensure that the getWheelVelocities() method" +
                            " has been overridden in your localizer.");
        ...
        double effectiveKf = RoadRunnerParameters.getMotorVelocityF(veloInchesToTicks(maxVelocity));
    ...
    private double veloInchesToTicks(double inchesPerSec) {
        return inchesPerSec / (2 * Math.PI * roadRunnerParameters.wheelRadius) /
                roadRunnerParameters.gearRatio * roadRunnerParameters.ticksPerRev;
    }
}
